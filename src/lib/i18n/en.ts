export const en = {
  ...
  dashboard: {
    ...
    tasksTodayDesc: "Tasks that need to be done today",
  ...
  setup: {
    addRoom: "Add Room",
    editRoom: "Edit Room",
    addRoomDesc: "Add a new room to your house",
    roomName: "Room Name",
    roomNamePlaceholder: "e.g. Kitchen, Bathroom, etc.",
    ...
    noTasks: "No tasks assigned to this room",
    ...
    allRooms: "All Rooms",
    noTasksInRoom: "No tasks found for the selected room",
    nextDue: "Next due",
  },
  frequency: {
    days: "Days",
